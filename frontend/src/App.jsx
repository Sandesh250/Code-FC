...
const TEAM_COLORS = {
  "Argentina": "#74ACDF", "Australia": "#FFCD00", "Belgium": "#EF3340",
...
function App() {
  ...
  const [teamBColor, setTeamBColor] = useState(TEAM_COLORS['Germany']);
  ...
  const handleReset = async () => {
    try {
      ...
      const data = await res.json();
      if (res.ok) {
        setProcessingState(data); setFile(null);
            ...
            <section className="glass-panel">
              ...
              >
                ...
                {file ? (
                  ...
                  <div>
                    <h3>Drag & Drop FIFA 2022 highlight video</h3>
